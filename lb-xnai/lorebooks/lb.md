...
{{#when::lb-xnai.scene.comic::tis::1}}Add each featured character depiction to the `characters` array of every panel where the character appears. Put each depiction's natural-language description in the same character entry.
...
<lb-xnai>
scenes[2]:
{{#when::lb-xnai.scene.comic::tis::1}}  - cast: 2gi{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}rls
    panels[2]:
      - characters[1]:
        - positive: gi{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}rl, adoles{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}cent, long pink straight h{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}air, white silk bl{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}ouse, ...
      ...
      - characters[2]:
        - positive: gi{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}rl, adoles{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}cent, long pink straight h{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}air, white silk bl{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}ouse, ...
          ...
          name: elodia de bellois
          description: ...
        - positive: gi{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}rl, fe{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}male, green single hair b{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}un, black knit dr{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}ess, ...
          name: bridgett baker
          description: ...
...
keyvis:
  camera: from ab{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}ove, upper bo{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}dy, dutch an{{#when::toggle::lb-xnai.forcedinsertion}}@{{/when}}gle
