...
{{/when}}{{/when}}{{/when}}
1. Narrative Context - Time (As accurate as possible) & World
2. Current Status - Situation & Location
3. List of Tuples of Recent Notable Events: `[Event, Relative Time][]`
4. For Each #3 Suitability As Topics - Public Visibility (at the moment/now): No suitable event or too low variety? -> #5, else -> #6
5. Plausible New Invented Events (generate surplus events and pick from the pool)
